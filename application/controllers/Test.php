...
class Test extends BaseController
{
    ...
    public function index()
    {
        ...
        $heading = "Thanks for contacting TechCentrica! Our team will shorty reach you back.";
        ...
        <td align='left' style='font-family: Montserrat, sans-serif;color:#2e2323; font-size:12px;line-height:24px' valign='middle' width='52.5%'><span>Suresh Sarkar</span></td>
        </tr>
        </div>
        ";
        $temp = get_email_temp($heading,$content);
