...
class Knowledge_base extends BaseController
{
    ...
    function index()
    {
        ...
        $data['title'] = 'Techcentrica :Knowledge Base';

        $deviceType = getDevice();
        if(isset($deviceType) && $deviceType == "mobile"){
            $this->load->view('admin/knowledge_base/managemobile', $data); 
        }else{
            $this->load->view('admin/knowledge_base/manage', $data); 
        }
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('admin/knowledge_base/add', $data); 
           } else {
             $image = "";
            // upload image start
    ...
    function edit($id)
    {
        ...
        if (isset($id) and !empty($id)) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $data['title'] = 'Techcentrica :Knowledge Base';
                $this->load->view('admin/knowledge_base/edit', $data); 
           ...
           // upload image end
                    ...
                    $result  = $this->knowledge_base->save($updateData);
                        ...
                        if($result >0){
                            ...
                            redirect('admin/knowledge_base/edit/'.$id);
                        }
            }
        }
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            if($fileExtension == "docx"){
                ...
                $fileType = '<img src="'.base_url().'assets/images/pdf.png" style="width:50px;" alt="">';
            }else if($fileExtension == "jpeg" || $fileExtension == "jpg" || $fileExtension == "png"){
                $fileType = '<img src="'.base_url().$currentObj->image.'" style="width:50px;" alt="">';
            }else{
            ...
            $row[] = '<a href="'.base_url('admin/knowledge_base/view/').$currentObj->id.'" class="nameClass">'.$fileType.'</a>';
            $row[] ='<a href="'.base_url('admin/knowledge_base/view/').$currentObj->id.'" class="nameClass">'.$currentObj->filename.'</a>';
                ...
                '<div class="dropdown">
                    <div class="" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="bi bi-three-dots-vertical"></i></div>
                      <div class="dropdown-menu leads showMe" aria-labelledby="dropdownMenuButton">
                        <ul>
                          <li class=""><a class="" href="' .base_url() .'admin/knowledge_base/view/' .$currentObj->id .'" title="View knowledge Base" ><i class="bi bi-eye-fill"></i> View</i></a></li>
                          <li class=""><a class="" href="' .base_url() .'admin/knowledge_base/edit/' .$currentObj->id .'" title="Edit knowledge Base" ><i class="bi bi-pencil-square"></i> Edit</i></a></li>
                          </ul>
                          </div>
                          </div>
                          </div>';
