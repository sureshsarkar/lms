...
class Documents extends BaseController
{
    ...
    function index()
    {
        ...
        $data['title'] = 'Techcentrica :Documents';
        
        $deviceType = getDevice();
        if(isset($deviceType) && $deviceType == "mobile"){
            $this->load->view('admin/documents/managemobile', $data); 
        }else{
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a href="'.base_url('admin/documents/view/').$currentObj->id.'" class="nameClass">'.$fileType.'</a>';
            $row[] ='<a href="'.base_url('admin/documents/view/').$currentObj->id.'" class="nameClass">'.$currentObj->filename.'</a>';
            ...
            $row[] ='<div class="dropdown">
                        <div class="" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="bi bi-three-dots-vertical"></i></div>
                           <div class="dropdown-menu leads showMe" aria-labelledby="dropdownMenuButton">
                                <ul>
                                    <li class=""><a class="" href="' .base_url() .'admin/documents/view/' .$currentObj->id .'" title="View Documents Base" ><i class="bi bi-eye-fill"></i> View</i></a></li>
                                    <li class=""><a class="" href="' .base_url() .'admin/documents/edit/' .$currentObj->id .'" title="Edit Documents Base" ><i class="bi bi-pencil-square"></i> Edit</i></a></li>
                                </ul>
                           </div>
                        </div>
                    </div>';
    ...
    function view($id)
    {
        if (isset($id) and !empty($id)) {
            ...
            $this->load->view('admin/documents/view', $data);
