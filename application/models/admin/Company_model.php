...

{
    ...
    var $column_order = array(null,'company.status','company.created_at','c.cat_name','sc.sub_category_name'); //set column field database for datatable orderable

    var $column_search = array('company.status','company.created_at','c.cat_name','sc.sub_category_name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('company.id,company.status,company.created_at,company.updated_at,c.cat_name,sc.sub_category_name');
    ...
    public function jointTables(){
        ...
        $this->db->join('category as c ',' c.id = company.category_id');

        $this->db->join('sub_category as sc ',' sc.id = company.sub_category_id');
