...

{
  ...
  public $column_order=array(null,'c.cat_name','sc.sub_category_name','banner.id', 'banner.category_id', 'banner.sub_category_id', 'banner.status', 'banner.created_at', 'banner.updated_at');
  public $column_search=array('c.cat_name','sc.sub_category_name','banner.id', 'banner.category_id', 'banner.sub_category_id', 'banner.status', 'banner.created_at', 'banner.updated_at');
  ...
  {     
    ...
    $this->db->select('banner.*,c.cat_name,sc.sub_category_name');
...

  {
   ...
   public function jointTables(){
    $this->db->from($this->table);
    $this->db->join('category as c ',' c.id = banner.category_id');
    $this->db->join('sub_category as sc ',' sc.id = banner.sub_category_id','left');
}
