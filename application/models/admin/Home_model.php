...

{
    ...
    var $column_order = array(null,'home.status','home.created_at','c.cat_name'); //set column field database for datatable orderable

    var $column_search = array('home.status','home.created_at','c.cat_name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('home.id,home.status,home.created_at,home.updated_at,c.cat_name');
    ...
    public function jointTables(){
        ...
        $this->db->join('category as c ',' c.id = home.category_id');

        // $this->db->join('sub_category as sc ',' sc.id = home.sub_category_id');
