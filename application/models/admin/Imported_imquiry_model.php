...
class Imported_imquiry_model extends Base_model

{
    public $table = "imported_imquiry";

    var $column_order = array('id','name','email','phone','city','state','platform','preference','capaingn_name','campaingn_date','interested_for','status','created_at','updated_at'); //set column field database for datatable orderable

    var $column_search = array('id','name','email','phone','city','state','platform','preference','capaingn_name','campaingn_date','interested_for','status','created_at','updated_at');//set column field database for datatable searchable 
