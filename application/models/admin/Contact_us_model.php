...

{
    ...
    var $column_order = array(null,'contact_us.status','contact_us.created_at','c.cat_name','sc.sub_category_name'); //set column field database for datatable orderable

    var $column_search = array('contact_us.status','contact_us.created_at','c.cat_name','sc.sub_category_name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('contact_us.id,contact_us.status,contact_us.created_at,contact_us.updated_at,c.cat_name,sc.sub_category_name');
    ...
    public function jointTables(){
        ...
        $this->db->join('category as c ',' c.id = contact_us.category_id');

        $this->db->join('sub_category as sc ',' sc.id = contact_us.sub_category_id');
