...

{
    ...
    var $column_order = array('name','email','phone','status','created_at'); //set column field database for datatable orderable

    var $column_search = array('name','email','phone','status','created_at');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('id,name,phone,email,role,status,system_ip,last_activity,last_login,last_logout,created_at,updated_at');
    ...
    public function jointTables(){
        ...
        // $this->db->join('category as c ',' c.id = category_id');
