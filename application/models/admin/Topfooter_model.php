...
class Topfooter_model extends Base_model

{

    public $table = "topfooter";

    var $column_order = array(null,'title','subtitle','status','created_at'); //set column field database for datatable orderable

    var $column_search = array('title','subtitle','status','created_at');//set column field database for datatable searchable 
