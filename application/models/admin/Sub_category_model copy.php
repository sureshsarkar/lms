...

{
    ...
    var $column_order = array(null,'c.cat_name','sub_category.sub_category_name','sub_category.status','sub_category.created_at'); //set column field database for datatable orderable

    var $column_search = array('c.cat_name','sub_category.sub_category_name','sub_category.status','sub_category.created_at');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('sub_category.*,c.cat_name');
