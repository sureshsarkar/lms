...
class Digi_solution_model extends Base_model

{
    public $table = "digi_solution";

    var $column_order = array(null,'digi_solution.status','digi_solution.created_at','c.cat_name','sc.sub_category_name'); //set column field database for datatable orderable

    var $column_search = array('digi_solution.status','digi_solution.created_at','c.cat_name','sc.sub_category_name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('digi_solution.id,digi_solution.status,digi_solution.created_at,digi_solution.updated_at,c.cat_name,sc.sub_category_name');
    ...
    public function jointTables(){
        ...
        $this->db->join('category as c ',' c.id = digi_solution.category_id');

        $this->db->join('sub_category as sc ',' sc.id = digi_solution.sub_category_id');
