...
class Design_dev_model extends Base_model

{
    public $table = "design_dev";

    var $column_order = array(null,'design_dev.status','design_dev.created_at','c.cat_name','sc.sub_category_name'); //set column field database for datatable orderable

    var $column_search = array('design_dev.status','design_dev.created_at','c.cat_name','sc.sub_category_name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('design_dev.id,design_dev.status,design_dev.created_at,design_dev.updated_at,c.cat_name,sc.sub_category_name');
    ...
    public function jointTables(){
        ...
        $this->db->join('category as c ',' c.id = design_dev.category_id');

        $this->db->join('sub_category as sc ',' sc.id = design_dev.sub_category_id');
