...
class User_history_model extends Base_model

{
    public $table = "user_history";

    var $column_order = array('id','owner_name','owner_id','login_at','logout_at','created_at','status'); //set column field database for datatable orderable

    var $column_search = array('id','owner_name','owner_id','login_at','logout_at','created_at','status');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('user_history.*,sa.name');
    ...
    public function jointTables(){
        ...
        $this->db->join('sub_admin as sa ',' sa.id = user_history.owner_id','left');
