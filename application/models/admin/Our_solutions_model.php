...
class Our_solutions_model extends Base_model

{
    public $table = "our_solutions";

    var $column_order = array(null,'our_solutions.status','our_solutions.created_at','c.cat_name','sc.sub_category_name'); //set column field database for datatable orderable

    var $column_search = array('our_solutions.status','our_solutions.created_at','c.cat_name','sc.sub_category_name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('our_solutions.id,our_solutions.status,our_solutions.created_at,our_solutions.updated_at,c.cat_name,sc.sub_category_name');
    ...
    public function jointTables(){
        ...
        $this->db->join('category as c ',' c.id = our_solutions.category_id');

        $this->db->join('sub_category as sc ',' sc.id = our_solutions.sub_category_id');
