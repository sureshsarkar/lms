...
class Experience_model extends Base_model

{
    public $table = "experience";

    var $column_order = array(null,'experience.status','experience.created_at','c.cat_name','sc.sub_category_name'); //set column field database for datatable orderable

    var $column_search = array('experience.status','experience.created_at','c.cat_name','sc.sub_category_name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('experience.id,experience.status,experience.created_at,experience.updated_at,c.cat_name,sc.sub_category_name');
    ...
    public function jointTables(){
        ...
        $this->db->join('category as c ',' c.id = experience.category_id');

        $this->db->join('sub_category as sc ',' sc.id = experience.sub_category_id');
