...

{
    ...
    var $column_order = array('campaign.id','filename','created_by','campaign.created_at','campaign.updated_at','sa.name'); //set column field database for datatable orderable

    var $column_search = array('campaign.id','filename','created_by','campaign.created_at','campaign.updated_at','sa.name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('campaign.*,sa.name as sname');
    ...
    public function jointTables(){
        ...
        $this->db->join('sub_admin as sa ',' sa.id = campaign.created_by','left');
