...

{
    ...
    var $column_order = array('id','name','email','phone','city','state','platform','preference','campaingn_date','interested_for','status','created_at','updated_at'); //set column field database for datatable orderable

    var $column_search = array('id','name','email','phone','city','state','platform','preference','campaingn_date','interested_for','status','created_at','updated_at');//set column field database for datatable searchable 
