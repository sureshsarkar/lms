...
class Documents_model extends Base_model

{
    public $table = "documents";

    var $column_order = array('documents.id','filename','created_by','documents.created_at','documents.updated_at','sa.name'); //set column field database for datatable orderable

    var $column_search = array('documents.id','filename','created_by','documents.created_at','documents.updated_at','sa.name');//set column field database for datatable searchable 
    ...
    {     
        ...
        $this->db->select('documents.*,sa.name as sname');
    ...
    public function jointTables(){
        ...
        $this->db->join('sub_admin as sa ',' sa.id = documents.created_by','left');
