...
class View_customer_model extends Base_model

{
    public $table = "enquery";

    var $column_order = array('id','name','email','phone','city','country','status','created_at','updated_at'); //set column field database for datatable orderable

    var $column_search = array('id','name','email','phone','city','country','status','created_at','updated_at');//set column field database for datatable searchable 
