      ...
      <div class="col col-xl-10">
        ...
        <div class="card cascading-right fgty" >
          <div class="card-body p-5 shadow-5  " style="padding: 34px 10px 10px 10px !important; margin-top: 0px;">
            ...
            <h2 class="fw-bold" style="display: block;font-size: 24px;font-weight: 500 !important; margin-bottom: 30px; line-height: 30px;transition: all .1s ease-in-out;">Sign in <br> <span class="sswe" >to access TechCentrica LMS<span> </h2>
