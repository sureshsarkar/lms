...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6 col-sm-6">
            ...
            <h1 class="  ml-3" style=" text-align: left;"><img src="https://cdn-icons-png.flaticon.com/512/1312/1312183.png" style="width:5%;"> Campaign</h1>
          ...
          <div class="col-md-12 col-12">
            ...
            <div class="card1">
              ...
              <div class="row">
                ...
                <div class="d-flex">
                    <div class="dropdown">
                       <h3 class="card-title m-2 "id="stat"><a href="<?= base_url(); ?>admin/campaign/add" class="btn-gradient-primary textCol"><i class="bi bi-plus-square" style="margin-right: 10px;" ></i>  Add New</a></h3>
                    </div>
                 </div>
                </div>
              </div>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery(document).on("click", ".sendEmail", function(){
          ...
          hitURL = "<?php echo base_url() ?>admin/campaign/sendEmail";
...
$(document).ready(function() {
    $(".clickCase").click(function() {
        ...
        url = url + 'admin/campaign?type=' + sortBy;
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/campaign/mobile_ajax_list')?>"+ getpayment_data,
