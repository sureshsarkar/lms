            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h1 class="  ml-3" style=" text-align: left;"><img
                            src="https://cdn-icons-png.flaticon.com/512/1312/1312183.png" style="width:5%;"> Campaign
                    </h1>
                                    ...
                                    <div class="d-flex">
                                        <div class="dropdown">
                                            <h3 class="card-title m-2 " id="stat"><a
                                                    href="<?= base_url(); ?>admin/campaign/add"
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/campaign/ajax_list')?>" + getpayment_data,
