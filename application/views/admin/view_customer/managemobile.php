            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h1 class="  ml-3" style=" text-align: left;"><img
                            src="   https://cdn-icons-png.flaticon.com/512/1165/1165674.png  " style="width:5%;"> View
                        Customers</h1>
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right ml-3">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url()?>admin/view_customer">View Customers</a></li>
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/view_customer/mobile_ajax_list')?>" + getpayment_data,
