            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url()?>admin/dashboard">Dashboard</a></li>
                        ...
                        <li class="breadcrumb-item"><a href="#">Document View</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                                       ...
                                       if(isset($edit_data->image) && !empty($edit_data->image)){
                                         ...
                                         $fileExtension = $fileInfo['extension'];
                                                ...
                                                if($fileExtension == "docx"){
                                                    ...
                                                    $fileType = '<img src="'.base_url().'assets/images/pdf.png" style="width:48px"  alt="'.$edit_data->filename.'">';
                            ...
                            <div class="card-footer">
                                <a href="<?= base_url()?>admin/documents" class="btn-gradient-primary"><i class="bi bi-arrow-left-short"></i> Back</a>
                            </div>
                    </div>
                    <!-- /.card -->
                </div>
