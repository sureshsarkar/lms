        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="h3 mb-3"><img src="https://cdn-icons-png.flaticon.com/512/1160/1160515.png" style="width:5%"  > Edit Document</p>
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url()?>admin/dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url()?>admin/documents">Document</a></li>
                        <li class="breadcrumb-item"><a href="#">Document Edit</a></li>
                        <a href=""><li class="breadcrumb-item"><a href="<?= base_url()?>admin/documents"> <span aria-hidden="true" class="crossbtn">&times;</span></a></li></a> 
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div >
                            ...
                            <!-- <h3 class="card-title">Edit Document 
                                ...
                                <div class="col-md-12 col-lg-12">
                                 <div class="row">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="filename" value="<?= $edit_data->filename?>" class="form-control" placeholder="Enter Document Name" required>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="file" name="image" class="form-control" placeholder="Enter Document image" required>
