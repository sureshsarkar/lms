...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <h1 class="  ml-3" style=" text-align: left;"><img src="   https://cdn-icons-png.flaticon.com/512/9746/9746243.png  " style="width:5%;"> Documents</h1>
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="row">
                ...
                <div class="d-flex">
                    <div class="dropdown">
                       <h3 class="card-title m-2 "id="stat"><a href="<?= base_url(); ?>admin/documents/add" class="btn-gradient-primary textCol"><i class="bi bi-plus-square"></i> Add New</a></h3>
                    </div>
                 </div>
                </div>
              </div>
...
$(document).ready(function() {
    $(".clickCase").click(function() {
        ...
        url = url + 'admin/documents?type=' + sortBy;
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/documents/mobile_ajax_list')?>"+ getpayment_data,
