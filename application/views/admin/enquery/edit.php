            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h1 class="  ml-3" style=" text-align: left;"><img
                            src="   https://cdn-icons-png.flaticon.com/512/11751/11751623.png " style="width:5%;">View
                        Lead</h1>
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <a href="">
                            <li class="breadcrumb-item"><a href="<?= base_url()?>admin/enquery"> <span
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <div class="table-responsiv1e">
                                                    <table class="table table-bordered table-striped">
                                                        <tr>
                                                            <th><i class="bi bi-person-check-fill text-info"></i> Name
                                                            </th>
                                                            <td> <?= $edit_data->name?></td>
                                                        </tr>

                                                        <tr>
                                                            <th><i class="bi bi-envelope-open text-info"></i> Email
                                                            </th>
                                                        ...
                                                        <tr>
                                                            <th><i class="bi bi-calendar-check text-info"></i> Created
                                                            </th>
                                                            <td> <?= date("Y-m-d h:i A",strtotime($edit_data->created_at))?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                ...
                                                ?>
                                                        <tr>
                                                            <th> <i
                                                                    class="bi bi-globe-central-south-asia text-info"></i>
                                                                Country </th>
                                                            <td> <?= $countryImg?></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <?= $this->config->item('source')[$edit_data->source]?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th><i class="bi bi-calendar-check text-info"></i> Lead
                                                                Status</th>
                                                            <td> <span
                                                                    class="badge bg-inverse-success"><?= $this->config->item('enquery_status')[$edit_data->enquery_type]?></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputFile" style="font-size: 17PX;"><i
                                                                class="bi bi-chat-dots"></i> Enter Your
                                                            Comments*</label>
                                                        <textarea name="followup_note" class="textClass"
                                                            placeholder="Enter FollowUp Note-" required autofocus
                                                            style="border: 1PX solid #b3afaf;"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputFile"><i
                                                                        class="bi bi-calendar-date-fill"></i> FollowUp
                                                                    Date*</label>
                                                                <input type="date" name="followup_date" id="type"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputFile"><i
                                                                        class="bi bi-journal-album"></i> Inquiry
                                                                    Status*</label>
                                                                <select name="enquery_status" class="form-control"
                                                                    required autofocus>
                                                                    <option value="4">Please Select</option>
                                                                    <option value="4">
                                                                        <?= $this->config->item('enquery_status')[4]?>
                                                                    </option>
                                                                    <option value="1">
                                                                        <?= $this->config->item('enquery_status')[1]?>
                                                                    </option>
                                                                    <option value="3">
                                                                        <?= $this->config->item('enquery_status')[3]?>
                                                                    </option>
                                                                    <option value="5">
                                                                        <?= $this->config->item('enquery_status')[5]?>
                                                                    </option>
                                                                    <option value="6">
                                                                        <?= $this->config->item('enquery_status')[6]?>
                                                                    </option>
                                                                    <option value="2">
                                                                        <?= $this->config->item('enquery_status')[2]?>
                                                                    </option>
                                                                    <option value="7">
                                                                        <?= $this->config->item('enquery_status')[7]?>
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputFile"><i
                                                                        class="bi bi-journal-album"></i> Inquiry
                                                                    Mode*</label>
                                                                <select name="enquery_mode" class="form-control"
                                                                    required autofocus>
                                                                    <option value="0">Please Select</option>
                                                                    <option value="1">
                                                                        <?= $this->config->item('enquery_mode')[1]?>
                                                                    </option>
                                                                    <option value="2">
                                                                        <?= $this->config->item('enquery_mode')[2]?>
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <button type="submit" class="active" style="width: 100%;"><i
                                                                    class="fa fa-paper-plane"
                                                                    aria-hidden="true"></i>Submit Follow up</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 py-2" style="background:#f7973d2e;border-radius: 10px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-1 pt-2">
                                                    <div class="form-group">
                                                        <span
                                                            class="badge bg-inverse-success"><?= (isset($value->enquery_mode))? $this->config->item('enquery_mode')[$value->enquery_mode]:"N/A"?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-1 pt-2">
                                                    <div class="form-group">
                                                        <span
                                                            class="badge bg-inverse-success"><?= (isset($value->lead_quality))? $value->lead_quality:"N/A"?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-1 pt-2">
                                                    <div class="form-group">
                                                        <span
                                                            class="badge bg-inverse-success"><?= $this->config->item('enquery_status')[$value->enquery_type]?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 pt-2" style="text-align: right;">
                                                    ...
                                                    <span
                                                        class="badge bg-inverse-warning p-2"><?= date("d F Y h:i A", strtotime($value->followup_date))?></span>
