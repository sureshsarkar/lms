                                           ...
                                           $i=0;  foreach  ($image_array as $key => $value) {$i++;?>
                                                    ...
                                                    <div class="d-flex flex-row bd-highlight mb-3">
                                                        ...
                                                        <div class="p-2 bd-highlight">
                                                            ...
                                                            <span class="pip " data_imagename="<?=$value?>"
                                                                data_index="<?=$i?>" data_id="spanid_<?=$i?>"
                                                                id="spanid_<?=$i?>">

                                                                <img src="<?php echo base_url(); ?>uploads/places/<?php echo $value;?>"
                                                                    class="imageThumb " data_id="<?=$i?>"
                                                                    data_imagename="<?=$value?>">
