            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <h1 class="  ml-3" style=" text-align: left;"><img
                            src="   https://cdn-icons-png.flaticon.com/512/2139/2139551.png  " style="width:5%;"> Manage
                        Inquiry</h1>
                            ...
                            <div class="d-flex flex-row">
                                <div class="dropdown">
                                    <div class="dropdown-toggle" title="View Lead By Filter" type="button"
                                        ...
                                        aria-expanded="false">ALL LEADS</div>
                                ...
                                <h3 class="card-title m-2" title="Add new inquiry" id="stat"><a
                                        href="<?php echo base_url(); ?>admin/enquery/add"
                                        class="btn-gradient-primary">ADD NEW</a></h3>
                                <h3 class="card-title m-2 export-btn" title="Export in Excel"
                                    onclick="exportTableToExcel('example')" id="stat"><a href="#"
                                        class="btn-gradient-primary"><i class="bi bi-download"></i> EXPORT</a></h3>
                                <h3 class="card-title m-2 sendEmail" title="Send Email For Festival" id="stat"><a
                                        href="#" class="btn-gradient-primary"><i class="bi bi-envelope-open-heart"></i>
                                        SEND EMAIL</a></h3>
                            </div>
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/enquery/ajax_list')?>" + type,
