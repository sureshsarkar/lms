    ...
    <div class="content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
              ...
              <h1 class="  ml-3" style=" text-align: left;"><img src="   https://cdn-icons-png.flaticon.com/512/2921/2921226.png  " style="width:5%;"> Edit Inquiry</h1>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="date" name="campaingn_date" class="form-control" value="<?= $edit_data->campaingn_date?>" placeholder="Enter Inquiry campaingn date" >
