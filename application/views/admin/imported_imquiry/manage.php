            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h1 class="ml-3" style=" text-align: left;"><img
                            src="https://cdn-icons-png.flaticon.com/512/2139/2139551.png" style="width:5%;"> All
                        Imported Inquiry</h1>
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right ml-3">
                        ...
                        <li class="breadcrumb-item"><a href="#">All Inquiry</a></li>
                    </ol>
                                    ...
                                    <div class="d-flex flex-row">
                                        <div class="dropdown">
                                            <h3 class="card-title m-2" title="Import Excel Sheet" id="stat"
                                                ...
                                                <a href="#" class="btn-gradient-primary textCol"><i
                                                        class="bi bi-cloud-arrow-down-fill"></i> IMPORT SHEET</a>
                                            </h3>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="staticBackdropLabel">Import
                                                                leads <i class="bi bi-cloud-download"
                                                                    style="color: #04aa6d;"></i>
                                                            </h5>
                                                            <a href="<?= base_url()?>assets/images/import-format.xlsx"
                                                                download>
                                            ...
                                            <h3 class="card-title m-2 export-btn" title="Export in Excel"
                                                onclick="exportTableToExcel('example')" id="stat">
                                                <a href="#" class="btn-gradient-primary"><i class="bi bi-download"></i>
                                                    EXPORT</a>
                                            </h3>
                                            <h3 class="card-title m-2" title="Add new inquiry" id="stat">
                                                <a href="<?php echo base_url(); ?>admin/imported_imquiry/add"
                                                    class="btn-gradient-primary"> <i class="bi bi-plus-circle"></i>
                                                    ADD</a>
                                            </h3>
                                            <h3 class="card-title m-2 deletByCheck resbtn">
                                                <a class="btn-gradient-primary"><i class="bi bi-archive"></i> DELETE
                                                    ALL</a>
                                            </h3>
                                        </div>
                                    </div>
