                            ...
                            <div class="d-flex flex-row">
                                <div class="dropdown">
                                    <h3 class="card-title m-2" title="Import Excel Sheet" id="stat"
                                        ...
                                        <a href="#" class="btn-gradient-primary" > <i class="bi bi-cloud-arrow-up"></i>
                                            IMPORT SHEET</a>
                                    </h3>
                                    ...
                                    <h3 class="card-title m-2" title="Add new inquiry" id="stat" ><a
                                            href="<?php echo base_url(); ?>admin/imported_imquiry/add"
                                            class="btn-gradient-primary" > <i class="bi bi-plus-circle"></i> ADD</a></h3>
                                    <h3 class="card-title m-2 deletByCheck resbtn"><a class="btn-gradient-primary"> <i
                                                class="bi bi-archive"></i> DELETE ALL</a></h3>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/imported_imquiry/mobile_ajax_list')?>" + type,
