...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <h1 class="  ml-3" style=" text-align: left;"><img src="      https://cdn-icons-png.flaticon.com/512/2471/2471120.png   " style="width:5%;"> Knowledge Base</h1>
...
$(document).ready(function() {
    $(".clickCase").click(function() {
        ...
        url = url + 'admin/knowledge_base?type=' + sortBy;
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/knowledge_base/mobile_ajax_list')?>"+ getpayment_data,
