        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h1 class=" ml-3 left" style="font-weight: 400;">Import Leads <img
                            src="<?= base_url()?>assets/images/download.gif" class="resgif" alt="" style="width: 10%;">
                    </h1>
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right ml-3">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('sub_admin/imported_imquiry') ?>">Import
                                Leads</a>
                        </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Import leads <i class="bi bi-cloud-download"
            ...
            <form action="<?= base_url()?>sub_admin/imported_imquiry/excelSheet" class="form-horizontal " method="post"
