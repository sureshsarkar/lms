...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <h1 class=" ml-3 left" style="    font-weight: 400;">Import Leads<img src="<?= base_url()?>assets/images/download.gif"  class="resgif"  alt="" style="
width: 10%;
"></h1>
...
<li class="breadcrumb-item"><a href="<?= base_url('sub_admin/dashboard') ?>">Import Leads</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="d-flex">
                      ...
                      <div class="respodiv"> 
                          <h3 class="card-title m-2" title="Import Excel Sheet" id="stat"  data-bs-toggle="modal" data-bs-target="#staticBackdrop"><a href="#" class="btn-gradient-primary textCol"><i class="bi bi-cloud-arrow-down-fill"></i>  IMPORT SHEET</a></h3>
                      </div>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="staticBackdropLabel" >Import leads <i class="bi bi-cloud-download"style="color: #04aa6d;"></i></h5>
                              <a href="<?= base_url()?>assets/images/import-format.xlsx" download>
                                  <button type="button" class="b-20" >Download Format <i class="bi bi-download"></i></button>
                              </a>
                            </div>
                      ...
                      <div class="">
                          <h3 class="card-title m-2 export-btn" title="Export in Excel" onclick="exportTableToExcel('example')" id="stat"><a href="#" class="btn-gradient-primary textCol"><i class="bi bi-download"></i> EXPORT</a></h3>
                      </div>
<?php }?>
                      <div class="">
                          <h3 class="card-title m-2 deletByCheck" ttle=""><a href="#" class="btn-gradient-primary textCol"><i class="bi bi-trash"></i> DELETE </a></h3>
                      </div>
                    </div>
                  </div>
                        </div>
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('sub_admin/imported_imquiry/mobile_ajax_list')?>"+ getpayment_data,
