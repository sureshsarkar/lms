...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <h1 class=" ml-3 left" style="    font-weight: 400;">Knowledge Base <img src="<?= base_url()?>assets/images/download.gif"  class="resgif"  alt="" style="
width: 10%;
"></h1>
...
<li class="breadcrumb-item"><a href="<?= base_url('sub_admin/dashboard') ?>">Knowledge Base</a></li>
...
$(document).ready(function() {
    $(".clickCase").click(function() {
        ...
        url = url + 'sub_admin/knowledge_base?type=' + sortBy;
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('sub_admin/knowledge_base/mobile_ajax_list')?>"+ getpayment_data,
