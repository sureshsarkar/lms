        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="h3 mb-3"><img src="https://cdn-icons-png.flaticon.com/512/1160/1160515.png" style="width:5%"  > Edit Knowledge</p>
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url()?>sub_admin/knowledge_base">Knowledge </a> </li>
                    
                    <li class="breadcrumb-item"><a href="#">Edit Knowledge </a> </li>
                                ...
                                <div class="col-md-12 col-lg-12">
                                 <div class="row">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="filename" value="<?= $edit_data->filename?>" class="form-control" placeholder="Name" required>
