...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <h1 class=" ml-3 left" style="    font-weight: 400;">View Customer <img src="<?= base_url()?>assets/images/download.gif"  class="resgif"  alt="" style="
width: 10%;
"></h1>
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('sub_admin/view_customer/mobile_ajax_list')?>" + getpayment_data,
