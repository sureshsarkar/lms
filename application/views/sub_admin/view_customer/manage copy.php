                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header  ">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        <h1 class=" left" style="font-weight: 400;">View Customer<img class="imgres" src="   https://cdn-icons-png.flaticon.com/512/3201/3201521.png " style="width:5%;">
                                        </h1>
                                ...
                                <ol class="breadcrumb float-sm-right">
                                  ...
                                  <li class="breadcrumb-item">
                                    <a href="<?= base_url('sub_admin/dashboard') ?>">Dashboard</a></li>
