...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <h1 class=" ml-3 left" style="    font-weight: 400;">View All Leads <img src="<?= base_url()?>assets/images/eye.gif"  class="resgif"  alt="" style="
width: 10%;
"></h1>
...
<li class="breadcrumb-item"><a href="<?= base_url('sub_admin/dashboard') ?>">Add New Lead</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="d-flex">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-toggle btn-gradient-primary" type="button"
                                        ...
                                        <h3 class="card-title m-2 export-btn" onclick="exportTableToExcel('example')" id="stat"><a href="<?= base_url(); ?>sub_admin/enquery" class="btn-gradient-primary textCol"><i class="bi bi-download"></i> EXPORT</a></h3>
                                    </div>
                                </div>
                                <div class="col-md-6 mthirty">
                                    <div class="d-flex resrt" style="justify-content: end;">
                                        ...
                                        <h3 class="card-title smnone " id="stat" style="margin-left: 9px; margin-top: 4px;">
                                          <a href="#" class="btn-gradient-primary textCol find_by_date"><i class="fa-solid fa-magnifying-glass"></i> SEARCH LEADS</a></h3>
                                        <h3 class="card-title bignone  " id="stat" style="margin-left: 9px;margin-top: 4px;">
                                          <a href="#" class="btn-gradient-primary textCol find_by_date"><i class="fa-solid fa-magnifying-glass"></i></a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
        ...
        jQuery(document).on("click", ".bookmark", function(){
          ...
          if(confirmation)
          {
            $.ajax({
                    type: "POST",
                    url: hitURL,
                    data: {id:tableId,bookmark:bookmark}, // serializes the form's elements.
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('sub_admin/enquery/mobile_ajax_list')?>"+ getpayment_data,
