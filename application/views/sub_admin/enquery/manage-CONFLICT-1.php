...
<li class="breadcrumb-item"><a href="<?= base_url('sub_admin/dashboard') ?>">View All Lead</a></li>
              ...
              <div class="row">
                ...
                <div class="d-flex">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-toggle button-62" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bullhorn" aria-hidden="true"></i> ALL LEADS</div>
                    ...
                    <h3 class="card-title m-2 export-btn" onclick="exportTableToExcel('example')" id="stat"><a style="
    margin-top: -8px;
" href="<?= base_url(); ?>sub_admin/enquery" class="button-62 textCol"><i class="bi bi-download"></i> EXPORT</a></h3>
                    ...
                    <span style="margin-left:10px;">
                      ...
                      <h3 class="card-title smnone " id="stat" style="
    margin-left: 9px;
    margin-top: 4px;
"><a href="#" class="btn-gradient-primary textCol find_by_date"><i class="fa-solid fa-magnifying-glass"></i> SEARCH LEADS</a></h3>
<h3 class="card-title bignone  " id="stat" style="
    margin-left: 9px;
    margin-top: 4px;
"><a href="#" class="btn-gradient-primary textCol find_by_date"><i class="fa-solid fa-magnifying-glass"></i></a></h3>
                      </div>
                      </div>
