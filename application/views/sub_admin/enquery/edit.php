        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h1 class="  ml-3" style=" text-align: left;"><img src="<?= base_url()?>assets/images/view.gif"
                            class="resgif" alt="" style="
    width: 5%;
"> View Inquiry</h1>
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('sub_admin/dashboard') ?>">View enquiry</a>
                        </li>
                        <a href="">
