          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?php endif; ?>
                ...
                <h3 class="card-title" id="stat">      <a href="<?php echo base_url(); ?>admin/contact_us/add" class="btn btn-info">ADD NEW</a>  </h3>
...
<script type="text/javascript">
   ...
   $.ajax({
     ...
     url:'<?php echo base_url()."admin/contact_us/delete"; ?>',
...
<script type="text/javascript">
   ...
   $.ajax({
     ...
     url:'<?php echo base_url()."admin/contact_us/deleteAll"; ?>',
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('admin/contact_us/ajax_list')?>",
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        jQuery(document).on("click", ".deletebtn", function(){
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>admin/contact_us/delete";
