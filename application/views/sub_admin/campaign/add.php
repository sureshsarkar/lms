            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="#">Add Documents </a> </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="exampleInputFile"><i
                                                            class="bi bi-file-richtext-fill text-info"></i>
                                                        Subject*</label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="exampleInputFile"><i
                                                            class="bi bi-file-break-fill text-info"></i> File
                                                        Name*</label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="exampleInputFile"><i
                                                            class="bi bi-cloud-upload text-info"></i> Upload*</label>

                                                    <input type="file" name="image" class="form-control"
                                                        placeholder="Upload image" accept=".webp, .jpg, .jpeg" required>
