...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <h1 class=" ml-3 left" style="    font-weight: 400;">Campaign <img src="<?= base_url()?>assets/images/download.gif"  class="resgif"  alt="" style="
width: 10%;
"></h1>
...
<li class="breadcrumb-item"><a href="<?= base_url('sub_admin/dashboard') ?>">Campaign</a></li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="row">
                ...
                <div class="d-flex">
                    <div class="dropdown">
                       <h3 class="card-title m-2 "id="stat"><a href="<?= base_url(); ?>sub_admin/campaign/add" class="btn-gradient-primary textCol"><i class="bi bi-plus-square"></i> Add New</a></h3>
                    </div>
                 </div>
                </div>
              </div>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery(document).on("click", ".sendEmail", function(){
          ...
          hitURL = "<?php echo base_url() ?>sub_admin/campaign/sendEmail";
          ...
          if(confirmation)
          {
            $.ajax({
                    type: "POST",
                    url: hitURL,
                    data: {sendEmail:"1",imgurl:imgurl,filename:filename,subject:subject}, // serializes the form's elements.
...
$(document).ready(function() {
    $(".clickCase").click(function() {
        ...
        url = url + 'sub_admin/campaign?type=' + sortBy;
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('sub_admin/campaign/mobile_ajax_list')?>"+ getpayment_data,
